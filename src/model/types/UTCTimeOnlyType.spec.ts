...
describe('UTCTimeOnlyType', function () {
  ...
  it('parse attributes', function () {
    ...
    let withoutTz = parseUTCTimeOnlyType(fixture(`
            <Parameter xsi:type="UTCTimeOnlyType_t"            
                name="withoutTz"
                fixTag="9999"
                constValue="12:30:00"
            ></Parameter>
    ...
    let withTz = parseUTCTimeOnlyType(fixture(`
            <Parameter xsi:type="UTCTimeOnlyType_t"            
                name="withTz"
                fixTag="6666"
                minValue="08:00:00"
    ...
    expect(withoutTz).toMatchObject({
      ...
      wireValue: '12:30:00.000'
    })

    withoutTz.wireValue = '11:22:33.123'
    expect(withoutTz.value).toMatchObject(new Date('1974-04-12T11:22:33.123Z'))
